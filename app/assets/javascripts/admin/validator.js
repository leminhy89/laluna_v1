...
var validator = (function($){
    ...
    */
    ...
    message = {
     ...
     /*message = {
        invalid         : '<%= I18n.t("laluna.messages.invalid") %>',
        checked         : '<%= I18n.t("laluna.messages.checked") %>',
        empty           : '<%= I18n.t("laluna.messages.empty") %>',
        min             : '<%= I18n.t("laluna.messages.min") %>',
        max             : '<%= I18n.t("laluna.messages.max") %>',
        number_min      : '<%= I18n.t("laluna.messages.number_min") %>',
        number_max      : '<%= I18n.t("laluna.messages.number_max") %>',
        url             : '<%= I18n.t("laluna.messages.url") %>',
        number          : '<%= I18n.t("laluna.messages.number") %>',
        email           : '<%= I18n.t("laluna.messages.email") %>',
        email_repeat    : '<%= I18n.t("laluna.messages.email_repeat") %>',
        password_repeat : '<%= I18n.t("laluna.messages.password_repeat") %>',
        repeat          : '<%= I18n.t("laluna.messages.repeat") %>',
        complete        : '<%= I18n.t("laluna.messages.complete") %>',
        select          : '<%= I18n.t("laluna.messages.select") %>'
    };*/
